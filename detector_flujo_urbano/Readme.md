...
El contador automático recibe como entrada un video y genera un archivo csv con el número de vehículos ligeros y pesados, taxis, motocicletas y personas. El contador actual obtiene buenos resultados con vehículos y taxis; para contar personas y motocicletas se requiere de mejorar los [parámetros](./parametros).
...
## Aprendizaje
Si quieres conocer cómo funciona este módulo de conteo automático, la carpeta [notebooks](./notebooks) contiene las explicaciones esenciales sobre el funcionamiento de main.py.
